      ...
      <div className="testimonials" id="testimonials">
        ...
        <div className="testimonials-wrapper">
          <div className="testimonial-list">
            <IndividualTestimony
              image="/media/images/stock-2.jpg"
            ...
            <IndividualTestimony
              image="/media/images/stock-1.jpg"
              name="Aaron Mayer"
            ...
            <IndividualTestimony
              image="/media/images/stock-3.jpg"
              name="Jones Mora"
            ...
            <IndividualTestimony
              image="/media/images/stock-4.jpg"
              name="Paul Dougherty"
            ...
            <IndividualTestimony
              image="/media/images/stock-5.jpg"
              name="Rocky Simpson"
